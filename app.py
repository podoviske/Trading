            ...
            with tab_monitor:
                ...
                if not df_c.empty:
                    ...
                    if not contas_g.empty:
                        ...
                        if meta_alvo > 0: col4.metric("Falta para Meta", f"${falta:,.2f}", f"Alvo: ${meta_alvo:,.0f}")
                        else: col4.metric("Modo Saque", "Sem Teto")
                        ...
                        with c_proj:
                            ...
                            elif meta_alvo > 0 and falta <= 0: st.success("Meta Atingida!")
                            elif meta_alvo == 0: st.success("Fase de Renda (Saque Livre)")
                            else: st.warning("Opere mais para projetar.")
