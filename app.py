...
st.set_page_config(page_title="EvoTrade Terminal v131", layout="wide", page_icon="📈")
...
if check_password():
    ...
    # ==============================================================================
    # 9. ABA CONTAS (MONITOR DE PERFORMANCE INTELLIGENT v131)
    # ==============================================================================
            ...
            with t4:
                ...
                if not df_c.empty:
                    ...
                    if not contas_g.empty:
                        ...
                        # Assumimos que a copiadora funciona, mas olhamos pelo saldo inicial mais baixo + lucro
                        menor_saldo_inicial = contas_g['saldo_inicial'].min()
                        saldo_atual_real = float(menor_saldo_inicial) + lucro_periodo

                        # --- 2. LÓGICA DE FASES (REGRAS DO USUÁRIO) ---
                        ...
                        # --- 4. CÁLCULO DE RISCO DE RUÍNA (VIDAS) ---
